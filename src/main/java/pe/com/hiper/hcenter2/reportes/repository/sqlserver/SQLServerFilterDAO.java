...
@Repository
public class SQLServerFilterDAO implements ICRUD<FilterDTO> {
	...
	public List<FilterDTO> findAll() {
		...
		// return null;
		return ForTestingAPIS.getListFilterDTO(0, 0);
	}

	@Override
	public List<FilterDTO> findByCuztomQuery(String cuztomQuery) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public boolean singleInsert(FilterDTO object) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public boolean singleUpdate(FilterDTO object) {
		// TODO Auto-generated method stub
		return false;
	}
